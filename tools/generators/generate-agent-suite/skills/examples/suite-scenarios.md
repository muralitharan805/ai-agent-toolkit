...
Verification Command: python3 tools/generators/generate-agent-suite/skills/scripts/verify_suite.py infra/redis/
========================================
```
...
Verification Command: python3 tools/generators/generate-skill/skills/scripts/validate_skill.py frameworks/angular/skills/cloudflare-angular-spa-deployment/
========================================
```
...
Action Plan:
  ...
  - Workflow: DEPRECATED (Not applicable).
Verification Command: python3 tools/generators/generate-rule/skills/scripts/validate_rule.py shared/security/rules/zero-hardcoded-secrets.md
========================================
```
