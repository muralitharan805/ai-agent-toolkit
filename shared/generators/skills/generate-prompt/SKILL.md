...
description: "Transforms raw requests into clean, production-ready, XML-structured LLM prompts. Triggered by 'generate-prompt:', 'prompt-architect:', or '/generate-prompt'."
---
...
## Gotchas
- Never include conversational introductory text ("Here is your prompt:") or post-generation explanations.
- Output MUST contain only the final optimized prompt block.
