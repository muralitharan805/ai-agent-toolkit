---
description: "Workflow to analyze complex processes (English, Tamil, or Thanglish) and generate structured workflow files under topic directories."
trigger: manual
---
...
3. Intelligently determine the topic-based target destination path:
   - Shared/general workflow: `shared/[topic]/workflows/[workflow-name].md`
   - Framework-specific workflow: `frameworks/[framework]/workflows/[workflow-name].md`
   - Infrastructure workflow: `infra/[tool]/workflows/[workflow-name].md`
