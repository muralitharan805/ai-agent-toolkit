---
description: "Workflow to analyze development constraints (English, Tamil, or Thanglish) and generate strict workspace rule files under topic directories."
trigger: manual
---
...
3. Intelligently determine the topic-based target destination path:
   - Shared/general rule: `shared/[topic]/rules/[rule-name].md`
   - Framework-specific rule: `frameworks/[framework]/rules/[rule-name].md`
   - Infrastructure rule: `infra/[tool]/rules/[rule-name].md`
