...
1. A complaint is a signal, **not proof** of recurring operational pain. AI-generated ideas, survey hypotheticals, forum JSON, API signals from `mine_problem_dorks.py`, and unchecked URLs are not primary behavioral evidence. Record provenance, observation date, evidence level, uncertainty and next verification per claim. Never invent interviews, competitor research, field visits, citations or audits. Generated search dorks only suggest searches; they do not establish validated market demand.
