...
/**
 * Service managing client-side document head metadata, Open Graph tags,
 * and canonical link element synchronization to eliminate duplicate indexing penalties.
 */
...
export class SeoService {
  ...
  /**
   * Sets the page title, standard meta description, Open Graph tags, and canonical link.
   *
  ...
  /**
   * Injects or updates the canonical link tag (<link rel="canonical" href="...">) in the head.
   * Automatically strips search query parameters to ensure deterministic canonical indexing.
   *
